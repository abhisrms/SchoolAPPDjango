...
urlpatterns = [
    ...
    path('get-fee/<str:cl>/', views.get_fee, name='get-fee'),
    path('update-fee/', views.update_fee_view, name='admin-update-class-fee'),
    ...
    path('student-fee-details/', views.student_fee_details, name='student-fee-details'),
    path('fee-history/<int:student_id>/', views.fee_history, name='fee-history'),
    path('add-payment/<int:student_id>/', views.add_payment, name='add-payment'),
    ...
    path('class-fee-report/', class_fee_report, name='class-fee-report'),
